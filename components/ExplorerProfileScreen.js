...
const styles=StyleSheet.create({
  ...
  reputationPill:{backgroundColor:INK.green,borderColor:INK.green,borderWidth:1},
  reputationNumber:{color:INK.green,fontSize:20,fontWeight:"900"},
  pointsPill:{backgroundColor:INK.blue,borderColor:INK.blue,borderWidth:1},
  scoreNumber:{color:"white",fontSize:20,fontWeight:"900"},
  pointsNumber:{color:INK.inkSoft,fontSize:20,fontWeight:"900"},
  ...
  statCardAccent:{backgroundColor:INK.blue,borderColor:INK.blue},
  statValue:{color:"white",fontSize:25,fontWeight:"900"},
  statValueAccent:{color:INK.blue},
  ...
  sectionEyebrow:{color:INK.blue,fontSize:10,fontWeight:"900",letterSpacing:0.7},
  rankTitle:{color:"white",fontWeight:"900",fontSize:16,marginTop:4},
  rankValues:{alignItems:"flex-end"},
  rankText:{color:INK.ink,fontWeight:"800",fontSize:12,marginVertical:2},
  ...
  reputationValue:{color:INK.green,fontSize:22,fontWeight:"900"},
  reputationLabel:{color:INK.inkSoft,fontWeight:"700",fontSize:11,marginTop:2},
  reputationMostUseful:{color:INK.ink,fontSize:12,lineHeight:18,marginTop:13},
  ...
  pointsBadgeText:{color:INK.blue,fontWeight:"900",fontSize:12},
  reviewStars:{color:INK.yellow,fontSize:18,letterSpacing:1,marginTop:12},
  ...
  verifiedText:{color:INK.green,fontSize:10,fontWeight:"900",letterSpacing:0.4},
  ...
  videoButtonText:{color:INK.inkSoft,fontSize:11,marginTop:2},
