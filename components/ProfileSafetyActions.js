...
const styles=StyleSheet.create({wrap:{paddingHorizontal:18,paddingTop:8},menuButton:{alignSelf:"flex-end",paddingHorizontal:12,paddingVertical:8},menuText:{color:INK.inkSoft,fontWeight:"900",fontSize:11},panel:{backgroundColor:INK.card,borderColor:INK.ink,borderWidth:1,borderRadius:13,padding:12,marginBottom:8},blockButton:{backgroundColor:INK.red,borderRadius:10,padding:11,alignItems:"center"},blockText:{color:INK.card,fontWeight:"900"},label:{color:INK.ink,fontWeight:"900",fontSize:12,marginTop:13,marginBottom:8},reasons:{flexDirection:"row",flexWrap:"wrap",gap:6},reason:{borderColor:INK.ink,borderWidth:1,borderRadius:17,paddingHorizontal:9,paddingVertical:6},reasonActive:{backgroundColor:INK.blue,borderColor:INK.blue},reasonText:{color:INK.card,fontSize:9,fontWeight:"800",textTransform:"capitalize"},reasonTextActive:{color:INK.card},reportButton:{backgroundColor:INK.red,borderRadius:10,padding:11,alignItems:"center",marginTop:11},reportText:{color:INK.card,fontWeight:"900"}});
