...
const styles=StyleSheet.create({
  ...
  rowEnd:{alignItems:"flex-end",gap:6},time:{color:INK.inkSoft,fontSize:10},arrow:{color:INK.brand,fontSize:22},unread:{minWidth:23,height:23,borderRadius:12,backgroundColor:INK.brand,alignItems:"center",justifyContent:"center",paddingHorizontal:6},unreadText:{color:INK.navy,fontSize:11,fontWeight:"900"}
});
