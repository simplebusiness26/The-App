...
const styles=StyleSheet.create({
  screen:{flex:1,backgroundColor:INK.paper},content:{padding:18,paddingBottom:70},center:{flex:1,backgroundColor:INK.paper,alignItems:"center",justifyContent:"center"},hero:{backgroundColor:INK.blue,borderColor:INK.blue,borderWidth:1,borderRadius:18,padding:17},eyebrow:{color:INK.blue,fontSize:10,fontWeight:"900",letterSpacing:1},title:{color:"white",fontSize:34,fontWeight:"900",marginTop:4},subtitle:{color:INK.ink,lineHeight:21,marginTop:7},heroActions:{flexDirection:"row",gap:9,marginTop:15},primaryButton:{flex:1,backgroundColor:INK.blue,borderRadius:12,padding:13,alignItems:"center"},primaryText:{color:"white",fontWeight:"900"},checkinButton:{flex:1,backgroundColor:INK.green,borderRadius:12,padding:13,alignItems:"center"},checkinText:{color:"white",fontWeight:"900"},errorCard:{backgroundColor:INK.red,borderColor:INK.red,borderWidth:1,borderRadius:12,padding:12,marginTop:13},errorText:{color:INK.ink},currentCard:{flexDirection:"row",alignItems:"center",backgroundColor:INK.green,borderColor:INK.green,borderWidth:1,borderRadius:14,padding:13,marginTop:13},currentText:{flex:1},currentLabel:{color:INK.green,fontSize:9,fontWeight:"900"},currentTitle:{color:"white",fontSize:17,fontWeight:"900",marginTop:3},currentMeta:{color:INK.inkSoft,fontSize:11,marginTop:3},endText:{color:INK.ink,fontWeight:"900",padding:8},filtersCard:{backgroundColor:INK.card,borderColor:INK.ink,borderWidth:1,borderRadius:15,padding:13,marginTop:13},filterLabel:{color:"white",fontWeight:"900",fontSize:12,marginTop:9,marginBottom:7},areaRow:{flexDirection:"row",gap:7},areaInput:{flex:1,backgroundColor:INK.card,borderColor:INK.ink,borderWidth:1,borderRadius:10,color:INK.ink,paddingHorizontal:11,paddingVertical:10},applyButton:{backgroundColor:INK.blue,borderRadius:10,paddingHorizontal:14,justifyContent:"center"},applyText:{color:"white",fontWeight:"900"},locationButton:{borderColor:INK.blue,borderWidth:1,backgroundColor:INK.blue,borderRadius:10,padding:11,alignItems:"center",marginTop:9},locationText:{color:INK.ink,fontWeight:"900",fontSize:11},chips:{flexDirection:"row",gap:6},chip:{flex:1,backgroundColor:INK.card,borderColor:INK.ink,borderWidth:1,borderRadius:9,paddingVertical:9,alignItems:"center"},chipActive:{backgroundColor:INK.blue,borderColor:INK.blue},chipText:{color:INK.inkSoft,fontWeight:"900",fontSize:10},chipTextActive:{color:"white"},typeTabs:{gap:7,paddingVertical:14},typeTab:{backgroundColor:INK.card,borderColor:INK.ink,borderWidth:1,borderRadius:18,paddingHorizontal:12,paddingVertical:8},typeTabActive:{backgroundColor:INK.blue,borderColor:INK.blue},typeText:{color:INK.inkSoft,fontWeight:"900",fontSize:11},typeTextActive:{color:"white"},card:{backgroundColor:INK.card,borderColor:INK.ink,borderWidth:1,borderRadius:15,padding:14,marginBottom:11},cardTop:{flexDirection:"row",alignItems:"center"},iconWrap:{width:43,height:43,borderRadius:22,backgroundColor:INK.blue,alignItems:"center",justifyContent:"center"},icon:{fontSize:20},cardHead:{flex:1,marginLeft:10},itemType:{color:INK.blue,fontSize:8,fontWeight:"900",textTransform:"uppercase",letterSpacing:.7},cardTitle:{color:"white",fontSize:17,fontWeight:"900",marginTop:2},distance:{color:INK.blue,fontWeight:"900",fontSize:11},subtitleText:{color:INK.inkSoft,lineHeight:19,marginTop:9},areaText:{color:INK.inkSoft,fontSize:12,marginTop:7},timeText:{color:INK.ink,fontSize:11,fontWeight:"800",marginTop:6},cardActions:{flexDirection:"row",alignItems:"center",justifyContent:"space-between",marginTop:12},openButton:{backgroundColor:INK.blue,borderRadius:10,paddingHorizontal:13,paddingVertical:10},openText:{color:"white",fontWeight:"900",fontSize:11},reportText:{color:INK.yellow,fontWeight:"900",fontSize:10,padding:8},emptyCard:{backgroundColor:INK.card,borderColor:INK.ink,borderWidth:1,borderRadius:15,padding:28,alignItems:"center"},emptyIcon:{fontSize:38},emptyTitle:{color:"white",fontSize:18,fontWeight:"900",marginTop:8},emptyText:{color:INK.inkSoft,textAlign:"center",lineHeight:19,marginTop:5}
});
