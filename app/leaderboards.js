...
const styles=StyleSheet.create({
  // Blue-bordered "where you stand" card, pinned above the ranked list --
  // FINAL_PRODUCT_CONTRACT.md's UI system section, verbatim.
  rankCard:{backgroundColor:INK.blue,borderColor:INK.ink,borderWidth:2,borderRadius:16,padding:18,marginBottom:14,alignItems:"center",...shadow},
  rankEyebrow:{color:INK.card,fontSize:10,fontWeight:"900",letterSpacing:0.7},
  rankValue:{color:INK.card,fontSize:38,fontWeight:"900",marginTop:6,fontVariant:["tabular-nums"]},
  ...
  tabs:{flexDirection:"row",backgroundColor:INK.card,borderColor:INK.ink,borderWidth:2,borderRadius:13,padding:4,marginBottom:9},
  tab:{flex:1,padding:11,borderRadius:10,alignItems:"center",backgroundColor:INK.card},
  tabActive:{backgroundColor:INK.blue},
  tabText:{color:INK.ink,fontWeight:"900"},
  tabTextActive:{color:INK.card},
  areaPill:{alignSelf:"flex-start",backgroundColor:INK.blue,borderColor:INK.ink,borderWidth:2,borderRadius:20,paddingHorizontal:12,paddingVertical:7,marginTop:4,marginBottom:12},
  areaText:{color:INK.card,fontWeight:"800",fontSize:12},
  loadingBox:{padding:50,alignItems:"center"},
  noticeCard:{backgroundColor:INK.card,borderColor:INK.ink,borderWidth:2,borderRadius:16,padding:20,marginTop:8,...shadow},
  noticeTitle:{color:INK.ink,fontSize:19,fontWeight:"900"},
  noticeText:{color:INK.inkSoft,lineHeight:21,marginTop:7},
  primaryButton:{backgroundColor:INK.blue,borderColor:INK.ink,borderWidth:2,borderRadius:11,padding:14,marginTop:15,...shadow},
  primaryText:{color:INK.card,fontWeight:"900",textAlign:"center"},
  errorCard:{backgroundColor:INK.red,borderColor:INK.ink,borderWidth:2,borderRadius:13,padding:15,...shadow},
  errorText:{color:INK.card,fontWeight:"700"},
  list:{gap:9},
  row:{backgroundColor:INK.card,borderColor:INK.ink,borderWidth:2,borderRadius:15,padding:12,flexDirection:"row",alignItems:"center",...shadow},
  ownRow:{borderColor:INK.blue,borderWidth:2},
  rankCircle:{width:42,height:42,borderRadius:21,backgroundColor:INK.card,borderColor:INK.ink,borderWidth:1.5,alignItems:"center",justifyContent:"center",marginRight:10},
  topRank:{backgroundColor:INK.red,borderColor:INK.ink},
  rank:{color:INK.ink,fontWeight:"900",fontSize:12,fontVariant:["tabular-nums"]},
  ...
  points:{color:INK.blue,fontSize:21,fontWeight:"900",fontVariant:["tabular-nums"]},
  pointsLabel:{color:INK.inkSoft,fontSize:9,fontWeight:"900",letterSpacing:0.6},
  rulesCard:{backgroundColor:INK.blue,borderColor:INK.ink,borderWidth:2,borderRadius:15,padding:17,marginTop:20,...shadow},
