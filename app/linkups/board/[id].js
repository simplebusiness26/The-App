...
const styles=StyleSheet.create({
  screen:{flex:1,backgroundColor:INK.paper},messages:{flex:1},content:{padding:16,paddingBottom:24},center:{flex:1,backgroundColor:INK.paper,alignItems:"center",justifyContent:"center",padding:28},errorTitle:{color:"white",fontSize:22,fontWeight:"900"},errorText:{color:INK.inkSoft,textAlign:"center",marginTop:8},backButton:{backgroundColor:INK.blue,borderRadius:12,padding:13,marginTop:17},backText:{color:"white",fontWeight:"900"},
  headerCard:{backgroundColor:INK.blue,borderColor:INK.blue,borderWidth:1,borderRadius:16,padding:15,marginBottom:14},eyebrow:{color:INK.blue,fontSize:9,fontWeight:"900",letterSpacing:.8},title:{color:"white",fontSize:23,fontWeight:"900",marginTop:5},when:{color:INK.inkSoft,fontSize:12,marginTop:7},readOnlyBanner:{color:INK.yellow,backgroundColor:INK.red,borderRadius:9,padding:9,marginTop:10,fontWeight:"800",fontSize:11,overflow:"hidden"},
  emptyCard:{backgroundColor:INK.card,borderColor:INK.ink,borderWidth:1,borderRadius:15,padding:28,alignItems:"center"},emptyIcon:{fontSize:36},emptyTitle:{color:"white",fontSize:18,fontWeight:"900",marginTop:8},emptyText:{color:INK.inkSoft,textAlign:"center",lineHeight:19,marginTop:5},
  messageCard:{backgroundColor:INK.card,borderColor:INK.hair,borderWidth:1,borderRadius:15,padding:13,marginBottom:10},myMessage:{borderColor:INK.blue,backgroundColor:INK.blue},announcementCard:{backgroundColor:INK.blue,borderColor:INK.blue},messageTop:{flexDirection:"row",alignItems:"center"},avatar:{width:38,height:38,borderRadius:19,backgroundColor:INK.blue,alignItems:"center",justifyContent:"center"},avatarText:{color:"white",fontWeight:"900"},authorText:{flex:1,marginLeft:9},author:{color:"white",fontWeight:"900"},time:{color:INK.inkSoft,fontSize:10,marginTop:2},announcementBadge:{color:INK.ink,fontSize:8,fontWeight:"900"},body:{color:INK.ink,lineHeight:21,marginTop:11},deletedBody:{color:INK.inkSoft,fontStyle:"italic"},messageActions:{flexDirection:"row",justifyContent:"flex-end",gap:16,marginTop:10},removeText:{color:INK.pink,fontWeight:"900",fontSize:11},reportText:{color:INK.yellow,fontWeight:"900",fontSize:11},
  reportPanel:{backgroundColor:INK.card,borderRadius:11,padding:10,marginTop:10},reasonWrap:{flexDirection:"row",flexWrap:"wrap",gap:5},reason:{borderColor:INK.ink,borderWidth:1,borderRadius:16,paddingHorizontal:9,paddingVertical:6},reasonActive:{backgroundColor:INK.blue},reasonText:{color:INK.inkSoft,fontSize:9,fontWeight:"800"},reasonTextActive:{color:"white"},submitReport:{backgroundColor:INK.red,borderRadius:9,padding:9,alignItems:"center",marginTop:9},submitReportText:{color:"white",fontWeight:"900",fontSize:11},
  composer:{backgroundColor:INK.card,borderTopColor:INK.hair,borderTopWidth:1,padding:12,paddingBottom:18},announcementToggle:{alignSelf:"flex-start",borderColor:INK.blue,borderWidth:1,borderRadius:16,paddingHorizontal:10,paddingVertical:6,marginBottom:8},announcementToggleActive:{backgroundColor:INK.blue,borderColor:INK.blue},announcementToggleText:{color:INK.inkSoft,fontSize:10,fontWeight:"900"},announcementToggleTextActive:{color:INK.ink},composerRow:{flexDirection:"row",alignItems:"flex-end",gap:8},input:{flex:1,maxHeight:110,minHeight:46,backgroundColor:INK.card,borderColor:INK.ink,borderWidth:1,borderRadius:12,color:INK.ink,paddingHorizontal:12,paddingVertical:11},sendButton:{backgroundColor:INK.blue,borderRadius:11,minWidth:72,height:46,alignItems:"center",justifyContent:"center"},sendText:{color:"white",fontWeight:"900"},counter:{color:INK.inkSoft,fontSize:9,textAlign:"right",marginTop:4},disabled:{opacity:.55}
});
