...
const styles=StyleSheet.create({
  ...
  tabs:{gap:8,paddingBottom:16},tab:{flexDirection:"row",alignItems:"center",gap:7,backgroundColor:"white",borderColor:INK.ink,borderWidth:1,borderRadius:20,paddingHorizontal:12,paddingVertical:8},activeTab:{backgroundColor:INK.blue,borderColor:INK.blue},tabText:{color:INK.inkSoft,fontWeight:"800",fontSize:12},activeTabText:{color:"white"},tabCount:{minWidth:22,height:22,borderRadius:11,backgroundColor:INK.card,alignItems:"center",justifyContent:"center"},activeTabCount:{backgroundColor:"rgba(255,255,255,0.2)"},tabCountText:{color:INK.inkSoft,fontSize:10,fontWeight:"900"},activeTabCountText:{color:"white"},
  card:{backgroundColor:"white",borderWidth:1,borderColor:INK.ink,borderRadius:14,padding:14,marginBottom:11,flexDirection:"row",alignItems:"flex-start"},
  ...
  message:{color:INK.ink,lineHeight:20,marginTop:7},pastMessage:{color:INK.inkSoft},time:{color:INK.inkSoft,fontSize:12,marginTop:8},emptyCard:{backgroundColor:"white",borderWidth:1,borderColor:INK.ink,borderRadius:16,padding:28,alignItems:"center",marginTop:20},emptyIcon:{fontSize:38},emptyTitle:{fontSize:19,fontWeight:"bold",marginTop:10,textAlign:"center"},emptyText:{color:"#666",marginTop:7,textAlign:"center"},primaryButton:{backgroundColor:INK.blue,paddingHorizontal:24,paddingVertical:14,borderRadius:11,marginTop:18},primaryText:{color:"white",fontWeight:"bold"}
});
