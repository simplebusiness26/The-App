...
const styles=StyleSheet.create({
  ...
  actionCard:{backgroundColor:"white",borderWidth:1,borderColor:INK.ink,borderRadius:16,padding:17,marginBottom:30},
  ...
  card:{backgroundColor:"white",padding:18,borderRadius:14,marginBottom:15,borderWidth:1,borderColor:INK.ink},
  clubCard:{backgroundColor:"white",padding:18,borderRadius:18,marginBottom:28,borderWidth:2,borderColor:INK.ink},
  ...
  emptyCard:{backgroundColor:"white",padding:20,borderRadius:14,borderWidth:1,borderColor:INK.ink},
