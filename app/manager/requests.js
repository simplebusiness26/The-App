...
const styles=StyleSheet.create({
  ...
  secondaryButton:{flex:1,borderWidth:1,borderColor:INK.ink,backgroundColor:"white",padding:12,borderRadius:10},
  secondaryButtonText:{textAlign:"center",fontWeight:"bold",color:INK.blue},
  focusSection:{backgroundColor:"white",borderRadius:16,padding:18,borderWidth:2,borderColor:INK.blue},
  clubSection:{backgroundColor:"white",borderRadius:16,padding:18,borderWidth:1,borderColor:INK.ink,marginBottom:18},
  ...
  noteCard:{backgroundColor:"white",borderRadius:10,padding:12,marginTop:13,borderWidth:1,borderColor:INK.ink},
  ...
  nextCard:{backgroundColor:"white",borderWidth:1,borderColor:INK.ink,borderRadius:16,padding:20,marginTop:16},
  ...
  emptyCard:{backgroundColor:"white",borderWidth:1,borderColor:INK.ink,borderRadius:16,padding:28,alignItems:"center"},
