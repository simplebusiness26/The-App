...
const styles=StyleSheet.create({
  screen:{flex:1,backgroundColor:INK.paper},content:{padding:18,paddingBottom:70},center:{flex:1,backgroundColor:INK.paper,alignItems:"center",justifyContent:"center"},eyebrow:{color:INK.blue,fontSize:10,fontWeight:"900",letterSpacing:1},title:{color:"white",fontSize:32,fontWeight:"900",marginTop:4},subtitle:{color:INK.inkSoft,lineHeight:21,marginTop:7},errorCard:{backgroundColor:INK.red,borderColor:INK.red,borderWidth:1,borderRadius:12,padding:12,marginTop:14},errorText:{color:INK.ink},label:{color:"white",fontWeight:"900",marginTop:18,marginBottom:8},optional:{color:INK.inkSoft},input:{backgroundColor:INK.card,borderColor:INK.ink,borderWidth:1,borderRadius:12,color:INK.ink,paddingHorizontal:13,paddingVertical:12},textarea:{minHeight:90},counter:{color:INK.inkSoft,fontSize:10,textAlign:"right",marginTop:4},areaHelp:{color:INK.inkSoft,fontSize:11,lineHeight:16,marginTop:6},wrap:{flexDirection:"row",flexWrap:"wrap",gap:7},chip:{backgroundColor:INK.card,borderColor:INK.ink,borderWidth:1,borderRadius:18,paddingHorizontal:11,paddingVertical:8},chipActive:{backgroundColor:INK.blue,borderColor:INK.blue},chipText:{color:INK.inkSoft,fontWeight:"800",fontSize:11},chipTextActive:{color:"white"},placePicker:{backgroundColor:INK.card,borderColor:INK.ink,borderWidth:1,borderRadius:14,padding:10,marginTop:11},placeRow:{flexDirection:"row",alignItems:"center",padding:9,borderRadius:10,marginTop:4},placeRowActive:{backgroundColor:INK.blue},placeText:{flex:1},placeName:{color:"white",fontWeight:"900"},placeAddress:{color:INK.inkSoft,fontSize:10,marginTop:3},check:{color:INK.ink,fontWeight:"900",fontSize:18},locationButton:{backgroundColor:INK.blue,borderColor:INK.blue,borderWidth:1,borderRadius:12,padding:13,alignItems:"center",marginTop:10},locationText:{color:INK.ink,fontWeight:"900"},removeLocation:{color:INK.inkSoft,fontWeight:"800",textAlign:"center",paddingVertical:9},durationRow:{flexDirection:"row",gap:7},duration:{flex:1,backgroundColor:INK.card,borderColor:INK.ink,borderWidth:1,borderRadius:10,padding:11,alignItems:"center"},durationActive:{backgroundColor:INK.green,borderColor:INK.green},durationText:{color:INK.inkSoft,fontWeight:"900"},durationTextActive:{color:INK.ink},visibilityRow:{flexDirection:"row",gap:9},visibility:{flex:1,backgroundColor:INK.card,borderColor:INK.ink,borderWidth:1,borderRadius:12,padding:13},visibilityActive:{backgroundColor:INK.blue,borderColor:INK.blue},visibilityTitle:{color:"white",fontWeight:"900"},visibilityHint:{color:INK.inkSoft,fontSize:10,marginTop:3},changeAudience:{color:INK.ink,fontWeight:"900",marginTop:9,textDecorationLine:"underline"},safetyCard:{backgroundColor:INK.green,borderColor:INK.green,borderWidth:1,borderRadius:13,padding:13,marginTop:20},safetyTitle:{color:INK.ink,fontWeight:"900"},safetyText:{color:INK.ink,fontSize:12,lineHeight:18,marginTop:5},submit:{backgroundColor:INK.blue,borderRadius:14,padding:16,alignItems:"center",marginTop:20},submitText:{color:"white",fontWeight:"900",fontSize:15},disabled:{opacity:.6}
});
