...
export const SECTIONS=[
  ...
  },
  {
    ...
    rows:[
      ...
      {label:"Listing catalogue",route:"/admin/listings",gate:GATES.ADMIN},
      {label:"Claims & Manager access",route:"/admin/claims",gate:GATES.ADMIN},
      {label:"Manage activities",route:"/admin/activities",gate:GATES.ADMIN},
      {label:"Review reports",route:"/admin/moderation",gate:GATES.ADMIN},
      {label:"Explorer directory",route:"/admin/explorers",gate:GATES.ADMIN},
      {label:"Areas & data quality",route:"/admin/areas",gate:GATES.ADMIN},
      {label:"Audit history",route:"/admin/audit",gate:GATES.ADMIN},
